    ...
    <main className="flex-1">
      <div className="mx-auto max-w-6xl space-y-12 px-0 py-8 md:space-y-16 md:px-4 md:py-12">
        <section className="space-y-5 px-4 md:px-0">
          <h1 className="text-3xl font-bold text-primary md:text-4xl">Eae!</h1>

          <p className="leading-relaxed text-foreground/80">
            Meu nome é Lucas Vinícius Marques, desenvolvedor de software na{" "}
            <a
              href={links.job.href}
              target="_blank"
            ...
            código que eu escrevi <em>realmente</em> ajudando outras pessoas é o
            que me faz continuar a desenvolver.
          </p>
