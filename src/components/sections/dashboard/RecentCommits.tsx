...
export function RecentCommitsSkeleton() {
  return (
    <div
      ...
      className='border-surface0 bg-base flex items-center justify-center rounded-xl border p-4 shadow-lg col-span-1 md:col-span-3'
    >
      <LoaderCircle
        size={24}
...
export async function RecentCommits() {
  ...
  return (
    <div className='border-surface0 bg-base rounded-xl flex flex-col border p-4 shadow-lg col-span-1 md:col-span-3'>
