...
export function Footer() {
  ...
  return (
    <footer className="m-auto mx-5 mb-5 bg-crust text-subtext0 border-surface0/20 flex h-auto flex-col items-center justify-center gap-y-3 rounded-lg border p-5 text-xs lg:text-sm md:flex-row md:justify-between md:gap-y-0">
